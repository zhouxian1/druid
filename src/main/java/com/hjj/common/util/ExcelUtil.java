...
public class ExcelUtil {  
    ...
    public List<Row> readExcel(String xlsPath) throws IOException{  
        ...
        try {  
            ...
            }else if("xlsx".equals(ext) || "xlsm".equals(ext) ){       //使用xlsx方式读取  
    ...
    public String getCellValue(Cell cell) {  
        ...
        if (cell != null) {  
            ...
            case Cell.CELL_TYPE_NUMERIC:  
            	if(HSSFDateUtil.isCellDateFormatted(cell)){ //判断当前是否存在日期
            		result = cell.getDateCellValue().getTime();
            	}else{
	...
	public Workbook getRootWb() {
		return rootWb;
	}

	public void setRootWb(Workbook rootWb) {
		this.rootWb = rootWb;
	} 
