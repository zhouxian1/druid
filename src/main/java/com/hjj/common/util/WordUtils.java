...
public class WordUtils {
	 ...
	 * @throws com.lowagie.text.DocumentException
	 */
	public void insertTableName(String tableName, int fontsize, int fontStyle, int elementAlign)
			throws DocumentException {
		Font titleFont = new Font(this.bfChinese, fontsize, fontStyle);
	 ...
	 * @throws com.lowagie.text.DocumentException
	 */
	public void insertContext(String contextStr, int fontsize, int fontStyle, int elementAlign)
			throws DocumentException {
		// 正文字体风格
	 ...
	 * @throws com.lowagie.text.DocumentException
	 */
	public void insertHtmlContext(String htmlContext) throws Exception {
		// 正文字体风格
		Paragraph context = new Paragraph();
		StyleSheet styleSheet = new StyleSheet();
		List htmlList = HTMLWorker.parseToList(new StringReader(htmlContext), styleSheet);
